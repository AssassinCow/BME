...
from bme_eating.training.hierarchical_v4_trainer import (
    load_v4_inputs,
    train_verifier_crossfit_v4,
)


def main() -> None:
    parser = argparse.ArgumentParser(description="Train StatsFusion v4 event verifiers")
    ...
    if args.fresh:
        raise SystemExit("Verifier training continues a candidate run; use --resume")
