...
from bme_eating.training.hierarchical_trainer import (
    ...
    train_boundary_crossfit,
)


def main() -> None:
    parser = argparse.ArgumentParser(description="Train subject-crossfit boundary refiners")
    ...
    if args.fresh:
        raise SystemExit("Boundary training continues an existing verifier run; use --resume")
